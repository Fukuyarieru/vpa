...
//        this.initializeComments();
    ...
    public void addComment(User user, String comment) {
        this.Comments.add(new Comment(user,comment,commentCounter));
    }
//    public void addComment(User user)
    public static Video Default() {
        Video defaultVideo=new Video("DefaultVideo",User.Default());
        defaultVideo.addComment(Comment.Default());
        return defaultVideo;
    }
